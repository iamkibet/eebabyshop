...
:class="{ 'shadow-lg': scrolled }">
        ...
        <div class="container mx-auto px-4">
            <div class="flex h-10 items-center justify-between text-sm">
                <div class="flex items-center space-x-4">
                    <a href="tel:+11234567890" class="flex items-center text-blue-900 hover:text-[#ff4c68] transition-colors">
                ...
                <div class="flex items-center space-x-4 text-center">
                    <span class="hidden sm:flex items-center text-[#2c1a22] dark:text-white/90">
                        <svg class="w-4 h-4 mr-2 text-[#ff6b8a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Main Navigation -->
    <header :class="scrolled ? 'bg-white/95 backdrop-blur-md dark:bg-[#0f0f0f]/95 border-b border-gray-100 dark:border-[#2a2a2a]' : 'bg-transparent'"
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('products', 'shop') }}" class="dropdown-link">Clothing</a>
                            <a href="{{ route('products', 'shop') }}" class="dropdown-link">Toys & Games</a>
                            <a href="{{ route('products', 'shop') }}" class="dropdown-link">Nursery</a>
                            <a href="{{ route('products', 'shop') }}" class="dropdown-link">Feeding</a>
                        </div>
                    </div>

                    <a href="{{ route('blog') }}" class="nav-link">Blog</a>
                    <a href="{{ route('contact-me') }}" class="nav-link">Contact</a>
                </nav>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="container mx-auto px-4 py-4">
                <div class="space-y-2">
                    ...
                    <a href="{{ route('products') }}" class="mobile-nav-link">Shop</a>
                    ...
                    <div x-data="{ categoriesOpen: false }" class="space-y-2">
                        ...
                        <div x-show="categoriesOpen" class="pl-4 space-y-2">
                            <a href="{{ route('products', 'shop') }}" class="mobile-nav-link">Clothing</a>
                            <a href="{{ route('products', 'shop') }}" class="mobile-nav-link">Toys & Games</a>
                            <a href="{{ route('products', 'shop') }}" class="mobile-nav-link">Nursery</a>
                            <a href="{{ route('products', 'shop') }}" class="mobile-nav-link">Feeding</a>
                        </div>
                    </div>

                    <a href="{{ route('blog') }}" class="mobile-nav-link">Blog</a>
                    <a href="{{ route('contact-me') }}" class="mobile-nav-link">Contact</a>
                    
                    <div class="pt-4 border-t border-gray-100 dark:border-gray-800">
                        @auth
                            <a href="{{ route('dashboard') }}" class="mobile-nav-link">My Account</a>
                        @else
