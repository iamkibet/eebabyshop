<x-layouts.guest>
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 md:py-12 lg:py-20">
        <div
            class="border-b bg-gradient-to-r from-[#fff0f4] to-[#1940de27] px-6 py-8 shadow-sm sm:px-10 md:px-16 lg:px-20">
            <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-6 md:grid-cols-4">
                <h1 class="col-span-2 text-4xl font-[1000] text-gray-900 sm:text-5xl md:col-span-1 md:text-5xl">Catalog
                </h1>
                <p class="col-span-2 text-lg leading-relaxed text-gray-700 sm:text-xl md:col-span-3">
