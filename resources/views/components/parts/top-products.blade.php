...
<ul class="mt-3 flex flex-col">
    ...
    @forelse($topProducts as $product)
        <li class="-mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg ">
            <a href="{{ route('product.show', $product->slug) }}" class="inline-flex w-full items-center gap-x-2 py-3 px-4 text-xs border text-gray-800 dark:border-slate-600 dark:text-neutral-200">
